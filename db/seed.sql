...
INSERT INTO audit.clause_evaluation VALUES
  ('ev-nr-72',  'cl-nr-72',  1, TIMESTAMP '2026-07-28 09:00:00', 'breach',  'Evidence missing · UAT pack not attached', '£340k held', '{"missing":["uat_pack"],"gate_date":"2026-07-17"}'),
  ('ev-nr-41',  'cl-nr-41',  1, TIMESTAMP '2026-07-28 09:00:00', 'at_risk', 'Rolling 30d: 99.1%', '£62k credit', '{"value":99.1,"threshold":99.5}'),
  ('ev-nr-94',  'cl-nr-94',  1, TIMESTAMP '2026-07-28 09:00:00', 'met',     'CO-2026-11 signed 14 Jul', NULL, '{}'),
  ('ev-nr-121', 'cl-nr-121', 1, TIMESTAMP '2026-07-28 08:10:00', 'met',     'Workday: 88% continuity', NULL, '{"value":88}'),
  ('ev-nr-63',  'cl-nr-63',  1, TIMESTAMP '2026-07-28 09:06:00', 'at_risk', 'CVE-2026-1180 · day 3 of 14', 'uncapped', '{"cve":"CVE-2026-1180","day":3,"window":14}'),
  ('ev-nr-152', 'cl-nr-152', 1, TIMESTAMP '2026-07-27 09:00:00', 'met',     '4 of 4 delivered on time', NULL, '{}'),
  ('ev-hh-63',  'cl-hh-63',  1, TIMESTAMP '2026-07-28 09:06:00', 'breach',  'CVE-2026-1180 · internet-facing prod unpatched', 'uncapped', '{"cve":"CVE-2026-1180"}'),
  ('ev-hh-72',  'cl-hh-72',  1, TIMESTAMP '2026-07-28 09:00:00', 'breach',  'Gate 3 evidence 9 days overdue', '£340k held', '{}'),
  ('ev-hh-41',  'cl-hh-41',  1, TIMESTAMP '2026-07-28 09:00:00', 'at_risk', 'Rolling 30d: 99.87%', NULL, '{"value":99.87}'),
  ('ev-cb-112', 'cl-cb-112', 1, TIMESTAMP '2026-07-28 08:00:00', 'met',     'Freeze respected · no prod change since 01 Jul', NULL, '{}'),
  ('ev-cb-41',  'cl-cb-41',  1, TIMESTAMP '2026-07-28 09:00:00', 'met',     'Rolling 30d: 99.98%', NULL, '{"value":99.98}'),
  ('ev-vu-52',  'cl-vu-52',  1, TIMESTAMP '2026-07-28 09:00:00', 'at_risk', 'Freshness 98.4% · threshold 99%', NULL, '{"value":98.4}'),
  ('ev-ol-31',  'cl-ol-31',  1, TIMESTAMP '2026-07-27 18:00:00', 'met',     'All milestones within window', NULL, '{}'),
...
INSERT INTO core.outcome VALUES
  ('out-nr-1', 'eng-nr', 'Passenger app crash-free rate', 99.5, '99.5%',    'gte', 'rolling', 30, 'crash_free_rate',   'jira'),
  ('out-nr-2', 'eng-nr', 'Depot telemetry coverage',      90,   '90 sites', 'gte', 'cumulative', NULL, 'telemetry_sites', 'jira'),
  ('out-nr-3', 'eng-nr', 'Mean incident response',        15,   '15 min',   'lte', 'rolling', 30, 'incident_response_mins', 'jsm'),
  ('out-nr-4', 'eng-nr', 'Ticketing throughput uplift',   15,   '+15%',     'gte', 'period', 91, 'ticketing_uplift_pct', 'derived'),
  ('out-nr-5', 'eng-nr', 'Legacy decommission',           7,    '7 systems','gte', 'cumulative', NULL, 'legacy_decommissioned', 'jira'),
  ('out-nr-6', 'eng-nr', 'Ops team certification',        40,   '40 staff', 'gte', 'cumulative', NULL, 'ops_certified', 'workday'),
  ('out-hh-1', 'eng-hh', 'Clinician portal availability', 99.9, '99.9%',    'gte', 'rolling', 30, 'availability_pct', 'jsm'),
  ('out-hh-2', 'eng-hh', 'Records migrated',              12,   '12m records','gte','cumulative', NULL, 'records_migrated_m', 'jira'),
  ('out-cb-1', 'eng-cb', 'Payments API availability',     99.95,'99.95%',   'gte', 'rolling', 30, 'availability_pct', 'jsm'),
  ('out-cb-2', 'eng-cb', 'Batch cut-over milestones',     3,    '3 waves',  'gte', 'cumulative', NULL, 'cutover_waves', 'jira'),
  ('out-vu-1', 'eng-vu', 'Telemetry freshness',           99,   '99%',      'gte', 'rolling', 30, 'freshness_ok_pct', 'jsm'),
  ('out-vu-2', 'eng-vu', 'Site onboarding',               400,  '400 sites','gte', 'cumulative', NULL, 'sites_onboarded', 'jira'),
  ('out-ol-1', 'eng-ol', 'Forecast accuracy',             92,   '92%',      'gte', 'rolling', 30, 'forecast_accuracy_pct', 'derived'),
  ('out-ol-2', 'eng-ol', 'Warehouse dashboards live',     6,    '6 sites',  'gte', 'cumulative', NULL, 'dashboards_live', 'jira'),
  ('out-sm-1', 'eng-sm', 'System availability',           99,   '99%',      'gte', 'rolling', 30, 'availability_pct', 'jsm'),
  ('out-sm-2', 'eng-sm', 'Maintenance backlog reduction', 30,   '−30%',     'gte', 'period', 91, 'backlog_reduction_pct', 'derived'),
  ('out-pm-1', 'eng-pm', 'Stream uptime',                 99.9, '99.9%',    'gte', 'rolling', 30, 'availability_pct', 'jsm'),
  ('out-pm-2', 'eng-pm', 'Cost per stream hour',          0.8,  '≤ £0.80',  'lte', 'rolling', 30, 'cost_per_stream_hr', 'derived'),
  ('out-kp-1', 'eng-kp', 'Pipeline availability',         99.5, '99.5%',    'gte', 'rolling', 30, 'availability_pct', 'jsm'),
  ('out-kp-2', 'eng-kp', 'Trial sites live',              24,   '24 sites', 'gte', 'cumulative', NULL, 'trial_sites_live', 'jira');
...
INSERT INTO core.delivery_outcome VALUES
  ('do-nr-1', 'eng-nr', 'Wave 3 live across 16 depots',        'Depot telemetry rollout wave 3 — remaining 16 sites',            'at_risk',  DATE '2026-08-14', 'out-nr-2'),
  ('do-nr-2', 'eng-nr', 'Crash-free ≥ 99.5% sustained',        'Passenger app stability programme to contractual threshold',     'at_risk',  DATE '2026-09-01', 'out-nr-1'),
  ('do-nr-3', 'eng-nr', 'CVE-2026-1180 remediated in prod',    'Ingest Gateway patched to v4.1.3 inside the §6.3 window',        'on_track', DATE '2026-08-10', NULL),
  ('do-nr-4', 'eng-nr', 'Legacy ticketing systems 4–7 retired','Decommission wave blocked behind wave 3 capacity',               'late',     DATE '2026-10-30', 'out-nr-5');
